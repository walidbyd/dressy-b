...
class SearchSubCategoryHistoryView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<SearchSubCategoryHistoryProvider>(
        builder: (BuildContext context,
            SearchSubCategoryHistoryProvider provider,
            Widget? child) {
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                CustomSearchSubCategoryHistoryListWidget(
                    searchSubCategoryHistoryList: provider.searchSubCategoryHistory.data!),
              ],
            ),
          ),
        );
