...
class HistoryCategoryListView extends StatefulWidget {
  const HistoryCategoryListView({
    Key? key,
  }) : super(key: key);

  @override
  _HistoryCategoryListViewState createState() =>
      _HistoryCategoryListViewState();
}

class _HistoryCategoryListViewState extends State<HistoryCategoryListView>
  ...
  List<Selection> categoryHistorySelection = <Selection>[];
  ...
  Widget build(BuildContext context) {
    ...
    holder = SerachHistoryParameterHolder().getCategorySerachHistoryList();
    holder!.getCategorySerachHistoryList().userId = psValueHolder.loginUserId;
                  ...
                  child: RefreshIndicator(
                    child: Column(children: <Widget>[
                      ...
                      CustomSearchHistoryDeleteAndSelectAllWidget(
                          ...
                          historySelection: categoryHistorySelection,
                          onTap: () {
                            setState(() {
                              isChecked = !isChecked;
                            });
