                ...
                children: <Widget>[
                  PsHero(
                    ...
                    child: Material(
                        ...
                        child: (valueHolder.hidePriceSetting == PsConst.ONE && isLoginUserEmpty==true)
                            ? Text(
                 ...
                 if (valueHolder.hidePriceSetting == PsConst.ONE && isLoginUserEmpty == true) const SizedBox() else Visibility(
                      maintainSize: true,
