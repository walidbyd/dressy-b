    ...
    for (PurchaseDetails purchaseDetails in purchaseDetailsList) {
      ...
      if (purchaseDetails.status == PurchaseStatus.purchased) {
        ...
        ItemPaidHistoryParameterHolder(
          ...
          // final ItemPromoteInAppPurchaseParameterHolder
          //     itemPromoteInAppPurchaseParameterHolder =
          //     ItemPromoteInAppPurchaseParameterHolder(
          //         itemId: widget.itemId,
          //         amount: amount,
          //         howManyDay: 'null',
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              ...
              children: <Widget>[
                Padding(
                  padding:
                      const EdgeInsets.only(right: 14, left: 14, top: 14.0),
                  child: Row(
                    children: <Widget>[
                ...
                Padding(
                  padding:
                      const EdgeInsets.only(right: 14, left: 14.0, bottom: 18),
                  child: Text(
                    'Choose Promotion'.tr,
                    style: Theme.of(context)
                        .textTheme
