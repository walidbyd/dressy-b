          ...
          body: Consumer2<AddToCartProvider, VendorUserDetailProvider>(
            builder: (_, AddToCartProvider provider,
              ...
              for (ShoppingCartItem item in shoppingCartList) {
                if (item.isSoldOut == '0') {
                  ...
                  if (item.isSelect == '1' && item.cartItemId != null) {
                    selectedAvaliableCartIdList
                        .add(int.parse(item.cartItemId!));
                  }
              ...
              if (provider.availableShoppingCartList.isEmpty) {
                ...
                provider
                    .addSelectedAvaliaveItemIdList(selectedAvaliableCartIdList);
              }
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              children: <Widget>[
                                ...
                                /// Available List View
                                if (provider
                                    .availableShoppingCartList.isNotEmpty)
                                  CustomAvailableVerticalListView(
                                      isVedorExpired: vendorUserDetailProvider
                                          ...
                                          0,
                                      title: provider
                                              .shoppingCart.data?.vendorName ??
                                          '',
                                      availableItemList:
                                          provider.availableShoppingCartList,
                                      vendorId: provider
                                              .shoppingCart.data?.vendorId ??
                                          ''),
                                    ...
                                    onPressed: !vendorExpOrSoldOut()
                                        ? () {
                                            if (provider.selectedAvaliableCartId
                                                .isNotEmpty) {
                                              Utils
                                                  .navigateOnUserVerificationView(
                                                      context, () async {
