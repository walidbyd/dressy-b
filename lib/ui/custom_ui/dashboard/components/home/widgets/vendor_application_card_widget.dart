...
class CustomVendorApplicationCard extends StatefulWidget {
  @override
  _CustomVendorApplicationCardState createState() => _CustomVendorApplicationCardState();
}
  class _CustomVendorApplicationCardState extends State<CustomVendorApplicationCard> {
