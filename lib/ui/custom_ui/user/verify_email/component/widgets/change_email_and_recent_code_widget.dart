...
class CustomChangeEmailAndRecentCodeWidget extends StatelessWidget {
  const CustomChangeEmailAndRecentCodeWidget({Key? key, this.isneedForgotPassword}) : super(key: key);


final bool? isneedForgotPassword;
  @override
  Widget build(BuildContext context) {
    return ChangeEmailAndRecentCodeWidget(isneedForgotPassword:isneedForgotPassword ,);
  }
}
